...
const ContactUsForm = () => {
  ...
  return (
    <div className="bg-steel-blue min-h-[680px] w-full px-[25px] py-[50px] lg:w-1/2 lg:px-[50px]">
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-[30px] text-white">
        {/* First Row */}
        ...
        {submitStatus && (
          <div
            className={`bg-frosted-white rounded p-4 text-center ${
              submitStatus.success ? 'bg-frosted-white text-steel-blue text-center' : 'text-red-800'
            }`}
          >
