  ...
  return (
    <Suspense fallback={<LoadingFallback />}>
      <div className="font-monaSans mx-auto mt-[150px] flex max-w-5xl flex-col px-[25px] pt-[50px] pb-[75px] lg:px-[50px] lg:pt-[25px]">
        ...
        <h6 className="text-eagle-navy font-monaSans mb-8 text-[16px]">Updated: 6/9/2025</h6>
        <div className="[&_h6]:text-eagle-navy text-justify [&_h6]:my-4 [&_ol]:mb-4 [&_ol]:list-decimal [&_ol]:pl-4 [&_p]:mt-4 [&_p]:mb-4 [&_ul]:mb-4 [&_ul]:list-disc [&_ul]:pl-8">
