...
const NavMenu = ({
  ...
  return (
    <div
      className={`bg-steel-blue fixed top-0 left-0 z-50 flex h-screen w-screen flex-col items-center justify-between ${isMenuOpen ? 'top-0' : 'top-[-100vh]'} pb-[50px] transition-all duration-500`}
    >
